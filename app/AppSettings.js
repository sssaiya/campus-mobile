module.exports = {
	...
	// TOPICS TESTING URL FOR PRODUCTION TEST BUILDS [DO NOT DEPLOY]
	MESSAGES_TOPICS_URL: 'https://s3-us-west-1.amazonaws.com/ucsd-mobile-dev/mock-apis/messaging/topics-testing.json',
	...
	PROMOTIONS_API_URL: 'https://ucsd-its-wts.s3-us-west-2.amazonaws.com/now_ucsandiego/v1/mobile-app-promo-banner.json',
	SPECIAL_EVENT_API_URL: 'https://2jjml3hf27.execute-api.us-west-2.amazonaws.com/prod/events/v1.1/special',
