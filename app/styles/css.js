...
const css = StyleSheet.create({
	...
	dataitem_row: { paddingVertical: 12, paddingHorizontal: 8, borderTopColor: COLOR.MGREY, borderTopWidth: 1 },
	dataitem_titleRow: { flexDirection: 'row' },
	dataitem_touchableTitle: { flex: 1, paddingVertical: 4 },
	dataitem_touchableStar: { paddingHorizontal: 4 },
